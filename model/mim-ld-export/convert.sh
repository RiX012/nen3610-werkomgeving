...
java -jar ~/GITREPO/rdf2rdf/target/rdf2rdf.jar nen3610-2022-ea.ttl nen3610-2022-mim.ttl ~/GITREPO/mimtools/ea2mim.yaml

# Third step: transform MIM model in RDF to RDFS/OWL/SHACL ontology
java -jar ~/GITREPO/rdf2rdf/target/rdf2rdf.jar nen3610-2022-mim.ttl nen3610-2022-ont.ttl ~/GITREPO/mimtools/mim2onto.yaml

# Fourth step: create diagram from ontology
